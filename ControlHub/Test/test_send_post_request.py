...
# r = requests.post('http://127.0.0.1:2002/alert', json={"device_id": "00000001"})
...
# r = requests.post('http://192.168.1.89:2002/register', json={"device_type": "PIRSensor", "device_id": "00000001"})
